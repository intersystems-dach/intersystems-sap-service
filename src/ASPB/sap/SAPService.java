 ...
 */
@NotForRealUse
@MyClassMetadata(Description = "A Service to receive messages from a SAP system.", InfoURL = "https://github.com/phil1436/intersystems-sap-service")
public class SAPService extends com.intersystems.enslib.pex.BusinessService
    ...
    @MyFieldMetadata(Category = "SAP Service Settings", Description = "If enabled the service will return a JSON object instead of a XML object")
    ...
    public Field getSetting(String name) {
        for (Field f : this.getClass().getDeclaredFields()) {
            if (f.isAnnotationPresent(ASPB.utils.annotations.MyFieldMetadata.class)) {
